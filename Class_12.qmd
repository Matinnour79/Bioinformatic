...
`arr.ind` find the position for the values which are true and `unique()` finds the repeat
...
We cannot trust these as we do not know how significant the values truly are.
